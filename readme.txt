...
2. choose the track (normally "E_track_5" or "Aalborg")
3. set the car [5 front 1 host 4 back] (yyf_1~yyf_5 human_ros yyf_7~yyf10) or (yyf_1~yyf_5 yyf_6 yyf_7~yyf10)
	the position of the host vehicle is defined in "leadingCarLabel"+1 in "yyf.cpp"
...
4. run roscore, trosc.py, display_Tcoordinate, rviz
	...
	display_Tccordinate
		receive BufferData, send marker
